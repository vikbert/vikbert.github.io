...
<div class="container text-centered">
  ...
  <p>
    Hi, I'm
    <strong>Vikbert</strong> from Berlin. This cybername comes from the names of my two
    kids:
    <strong>Vik</strong>toria & Al<strong>bert</strong>.
  </p>
  <p>
    I work as a software engineer since 2010, after my "Diplom Informatik"
    study at TU Berlin. Mostly, I use the the Symfony framework
    <a
      target="_blank"
  ...
  <p>
    ...
    <a
      ...
      target="_blank"
      rel="noreferer noopener"><strong>Manifesto for Agile Software Development</strong></a>.
  </p>
